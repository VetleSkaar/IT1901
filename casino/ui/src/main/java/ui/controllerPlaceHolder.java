...
public class controllerPlaceHolder {
    ...
    private codePlaceHolder calc;

    public controllerPlaceHolder() {
        calc = new codePlaceHolder(0.0, 0.0, 0.0);
    }

    public codePlaceHolder getCalc() {
        return calc;
    }

    public void setCalc(codePlaceHolder calc) {
        this.calc = calc;
        updateOperandsView();
    }
