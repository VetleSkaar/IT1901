...
public class Blackjack {
    ...
    /** if a card is drawn
     * @return a String of the event "'Player' got 'Card'. They now have 'All Cards'. Total: 'total sum'"
     */
    ...
    /**
     * Finishes players round, adds action adds action to history, and continues to next player
    ...
    /**
     * doubles potential return by 100%. In return player must stand after first hit. 
     * @param player, player proforming stand
    ...
    /**
     * It gives the player the option of splitting the cards into two separate hands, 
     * then receiving an additional card for each hand from the dealer. 
     * @param player
     * @throws IllegalCallerException if action "double down" is unavailable. 
     */
